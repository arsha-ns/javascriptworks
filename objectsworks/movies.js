...
// var belowRuntime=filims.filter(f=>f.runtime<140).map(p=>p.title)

// console.log(belowRuntime);


// var highestruntime=filims.reduce((f1,f2)=>f1.runtime>f2.runtime?f1.title:f2.title)


// var highestruntime=filims.sort((f1,f2)=>f1.runtime-f2.runtime)
...
// var lowestruntime=filims.reduce((f1,f2)=>f1.runtime<f2.runtime?f1.title:f2.title)

// console.log(lowestruntime);


// var wc={}
// filims.map(y=>y.year in wc?wc[y.year]+=1:wc[y.year]=1)
// console.table(wc);


// console.log(Object.entries(wc).reduce((o1,o2)=>o1[1]>o1[2]?o1:o2));
...
// var moviegenre=filims.filter(f=>f.genres=="Action" || f.genres=="Drama") .map(f=>f.id)

// console.log(moviegenre);


// var mostnoyear=filims.reduce((f1,f2)=>f1.year>f2.year?f1.title:f2.title)

// console.log(mostnoyear);
